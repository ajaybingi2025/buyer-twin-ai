...
BuyerTwin AI is an AI-powered decision copilot for real estate agents. It helps agents understand buyer intent, prioritize serious leads, recommend relevant listings, and generate personalized outreach to improve conversion from existing buyer pipelines.
...
5. Agents use ranked insights to take the next best action.
...
- Generic follow-up reduces response rates
...
The backend handles API orchestration, structured data flow, routing, authentication, and persistence for buyer, listing, and outreach data.

### AI / ML Layer

The AI / ML layer powers BuyerTwin modeling, buyer scoring, listing ranking, recommendation logic, and personalized communication generation.
...
```bash
git clone https://github.com/ajaybingi2025/buyer-twin-ai.git
cd buyer-twin-ai
```
...
This project was built as part of a hackathon prototype.
